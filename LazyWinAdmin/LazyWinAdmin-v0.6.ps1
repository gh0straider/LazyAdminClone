#========================================================================
# Name				: LazyWinAdmin-v0.6.ps1
# Original Author 	: Francois-Xavier Cat
# Author 			: Gary Lewis
...
#	0.5		20190206 Private Update Version
#   0.6     20190404 Added ability to check local admin group and Add user to local admin
#========================================================================
...
#region Call-Global_ps1
	...
	#region Get-UserID
	function Get-UserID
	{	$global:UserID = $textbox_UserID.Text}
	#endregion
...
function Call-MainForm_pff
{
    ...
    $button_chkadmin = New-Object 'System.Windows.Forms.Button'
    $button_addadmin = New-Object 'System.Windows.Forms.Button'
    $textbox_UserID = New-Object 'System.Windows.Forms.TextBox'
	...
	$ApplicationLastUpdate	= "2019/02/06"
	
	# Author Information
	# Original Author = "Francois-Xavier Cat"
	$AuthorName			= "Gary Lewis"
	$AuthorEmail 		= "gh0st.raider@gmail.com"
	$AuthorBlogName 	= "NA"
	$AuthorBlogURL 		= "NA"
	$AuthorTwitter 		= "@gh0straider"
	$AuthorTwitterURL	= "https://twitter.com/gh0straider"
	...
	$button_chkadmin_Click={
		Get-ComputerTxtBox
		Add-logs -text "$ComputerName - CHECKING ADMIN GROUP"
		$result = Invoke-Command -ComputerName $ComputerName -ScriptBlock {Invoke-Expression -Command:"net localgroup administrators"} | Out-String
        Add-RichTextBox $result
	}

    $button_addadmin_Click={
		Get-ComputerTxtBox
        Get-UserID
		Add-logs -text "$ComputerName - Adding User $UserID to Admin Group"
        $user_param = $textbox_UserID.Text
		$result = Invoke-Command -ComputerName $ComputerName -ScriptBlock {Invoke-Expression -Command:"net localgroup administrators ITSERVICES\$Using:UserID /add"} | Out-String
        Add-RichTextBox $result
	}
	...
	$buttonC_Click={
		...
		$Command = "$ToolsFolder\ExplorerPP.exe"
		$Args = $PathToCDrive
		if(Test-Path "$ToolsFolder\ExplorerPP.exe"){
		Start-Process $Command $Args
	#	$command="$ToolsFolder\ExplorerPP.exe $PathToCDrive"
	#	Start-Process $command
		}
		else {$buttonC.ForeColor = 'Red'}
	}
	...
	$Form_Cleanup_FormClosed=
	{
		...
		try
		{
            ...
            $button_chkadmin.remove_Click($button_chkadmin_Click)
            $button_addadmin.remove_Click($button_addadmin_Click)
            $textbox_UserID.remove_Click($textbox_UserID_Click)
...
yOl5co93qgAAAABJRU5ErkJggg==')
    ...
    $tabpage_ExternalTools.Controls.Add($button_addadmin)
    $tabpage_ExternalTools.Controls.Add($textbox_UserID)
    $tabpage_ExternalTools.Controls.Add($button_chkadmin)
	...
	# button_addadmin
	#
	$button_addadmin.Location = '203, 76'
	$button_addadmin.Name = "button_addadmin"
	$button_addadmin.Size = '75, 23'
	$button_addadmin.TabIndex = 47
	$button_addadmin.Text = "AddAdmin"
	$button_addadmin.UseVisualStyleBackColor = $True
	$button_addadmin.add_Click($button_addadmin_Click)
    #
	# textbox_UserID
	#
	$textbox_UserID.Location = '289, 76'
	$textbox_UserID.Name = "textbox_UserID"
	$textbox_UserID.Size = '75, 23'
	$textbox_UserID.TabIndex = 46
	$textbox_UserID.Text = ""
    #
	# button_chkadmin
	#
	$button_chkadmin.Location = '203, 52'
	$button_chkadmin.Name = "button_chkadmin"
	$button_chkadmin.Size = '75, 23'
	$button_chkadmin.TabIndex = 45
	$button_chkadmin.Text = "ChkAdmin"
	$button_chkadmin.UseVisualStyleBackColor = $True
	$button_chkadmin.add_Click($button_chkadmin_Click)
	#
